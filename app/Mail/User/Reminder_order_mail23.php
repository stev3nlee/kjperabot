...
class Reminder_order_mail23 extends Mailable
{
    ...
    public function build()
    {
      ...
      $tempOrder->is_remindered_23 = 1;
      $tempOrder->save();

      Order_history::create([
        "order_id"=>$order->id,"action"=>"Remindered 47"
      ]);

      return $this->view('email/reminder_order23')->subject("Reminder Order #".$this->order_no)->with([
        "order"=>$order,
        "details"=>$details
      ]);
    }

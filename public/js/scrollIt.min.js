(function(c) {
    ...
    c.scrollIt = function(m) {
        var h = c.extend(d, m),
            g = 0,
            k = c("[data-scroll-index]:last").attr("data-scroll-index");
        var i = function(n) {
            if (n < 0 || n > k) {
                return
            }
            var o = c("[data-scroll-index=" + n + "]").offset().top + h.topOffset - 80;
            c("html,body").animate({
                scrollTop: o,
                easing: h.easing
            }, h.scrollTime)
        ...
        var j = function(o) {
            var n = c(o.target).closest("[data-scroll-nav]").attr("data-scroll-nav") || c(o.target).closest("[data-scroll-goto]").attr("data-scroll-goto");
            i(parseInt(n))
        };
        var f = function(o) {
            var n = o.which;
        ...
        c("body").on("click", "[data-scroll-nav], [data-scroll-goto]", function(n) {
            n.preventDefault();
            j(n)
        })
    }

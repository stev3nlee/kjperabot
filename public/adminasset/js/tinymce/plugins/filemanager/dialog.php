...
<!----- header div end ------->
	...
	$link.=(!empty($_GET['editor']) ? $_GET['editor'] : 'mce_0');
	$link.="&popup=".$popup."&lang=";
	$link.=(!empty($_GET['lang']) ? $_GET['lang'] : 'en_EN');
	$link.="&field_id=";
	...
	<div class="span12">
	    ...
	    <br/>
	    <div class="alert alert-error">There is an error! The root folder not exist. <?php echo $root . $cur_dir ?></div>
	    <?php }else{ ?>

															...
															<tbody>
															  ...
															  <tr>
																...
																<td valign="top" style="padding: 5px 0;">
																  ...
																  <div style="color:orange;">{{$order_string[$order->order_status]}}</div>
																  @elseif ($order->order_status == 2)
																	<div style="color:blue;">{{$order_string[$order->order_status]}}</div>
																  @elseif ($order->order_status == 3)
																	<div style="color:green;">{{$order_string[$order->order_status]}}</div>
																  @elseif ($order->order_status == 4)
																	<div style="color:red;">{{$order_string[$order->order_status]}}</div>
																  @else
																	<div>{{$order_string[$order->order_status]}}</div>
																  @endif
																</td>
															  </tr>
															  <tr>
																<td valign="top" width="190" style="padding: 5px 0;">STATUS PENGIRIMAN</td>
																  @if($order->order_status == 3 and $order->jne_track != null)
																<td valign="top" style="padding: 5px 0;"><div>{{ $order->jne_track }}</div></td>
																@else
																  <td valign="top" style="padding: 5px 0;">
